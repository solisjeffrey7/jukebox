...
# ============================================================
# OFFLINE INSTALLER BUILDER v3.28
# ============================================================
#
# BASE: v3.27
#
...
# • Same colors / spacing / progress / error UI
#
# LIBACL FIX v3.28
# ------------------------------------------------------------
# • Never use shared Android storage as LD_LIBRARY_PATH
# • Copy bootstrap/libacl to Termux private HOME
# • Use private libacl path for dpkg/tar
